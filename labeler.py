...
def generate_labels(csv_filepath, mappings_json, labels_json, random_generator, one_word_answers=False):
...
if __name__=="__main__":
    ...
    parser.add_argument('--mode', choices=['full_answers', 'one_word'], required=False)
